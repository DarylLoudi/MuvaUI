--[[
    MuvaUI — System Core Test v2
    Fix: LoadingScreen tanpa overlay abu-abu
    Key valid: MUVA-TEST-1234-5678
--]]

local COMMIT = "cb7b1317d6728d9a014cc0ca53709cf84d6eb910"
local MuvaUI = loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/DarylLoudi/MuvaUI/" .. COMMIT .. "/MuvaUI.lua",
    true
))()

print("[SysCore v2] Loaded.")
...
MuvaUI:SetConfigSystem({ File="syscore_v2_configs.json", Slots=3 })

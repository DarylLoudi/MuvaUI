...
function Window.new(opts, screenGui, flags)
    print("[MuvaUI] Window.new started")
    ...
    print("[MuvaUI] Theme accent set: " .. Color.toHex(accent))
    ...
    print("[MuvaUI] Window.new complete")
    return self
end
...
function Window:_selectTab(tab, navBtn)
    ...
    for _, child in ipairs(self._sidebar:GetChildren()) do
        if child:IsA("TextButton") then
            ...
            if child._bar   then child._bar.BackgroundTransparency = 1 end
            if child._label then child._label.TextColor3 = Theme:Text(3); child._label.Font = Enum.Font.Gotham end
            if child._icon  then child._icon.TextColor3  = Theme:Text(3) end
        end
    end
    -- Activate selected
    tab:Show()
    ...
    navBtn._bar.BackgroundTransparency = 0
    navBtn._label.TextColor3      = Color.fromHex("#d4b3fa")
    navBtn._label.Font            = Enum.Font.GothamBold
    if navBtn._icon then navBtn._icon.TextColor3 = Theme:Accent() end
    self._activeTab = tab
end
...
Section.AddSlider = function(self, opts)
    ...
    valueLbl.Size                   = UDim2.new(0, 50, 1, 0)
...
function Library:CreateWindow(opts)
    print("[MuvaUI] CreateWindow called: " .. tostring(opts.Title))

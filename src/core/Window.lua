...
function Window.new(opts, screenGui, flags)
    ...
    -- Sidebar layout: UIListLayout vertikal untuk search + navScroll + user
    ...
    -- Nav items scrollframe — fills remaining space via UIFlexItem
    local navScroll = Instance.new("ScrollingFrame")
    navScroll.BackgroundTransparency = 1
    navScroll.BorderSizePixel        = 0
    navScroll.Size                = UDim2.new(1, 0, 1, -78)  -- fallback, flex overrides
    ...
    local navFlex = Instance.new("UIFlexItem")
    navFlex.FlexMode = Enum.UIFlexMode.Fill
    navFlex.Parent   = navScroll
    ...
    -- User profile (bottom, fixed height in layout)
    ...
    -- Divider di atas userFrame (absolut, tidak masuk UIListLayout horizontal)
    ...
    userDivider.Position = UDim2.new(0, 0, 0, 0)

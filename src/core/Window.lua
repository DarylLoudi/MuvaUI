...
function Window.new(opts, screenGui, flags)
    ...
    -- TITLEBAR — no UICorner. win.ClipsDescendants=true clips it to rounded boundary.
    ...
    -- SIDEBAR — no UICorner. win.ClipsDescendants=true clips it to the rounded boundary.

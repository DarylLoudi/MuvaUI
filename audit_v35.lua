...
local AUDIT_VERSION = "3.5"
-- Gunakan commit hash agar executor tidak bisa cache (URL unik per commit)
local COMMIT = "3ba6291b7e75d7bc7a6f26d648491e97ad921002"
local LIB_URL = "https://raw.githubusercontent.com/DarylLoudi/MuvaUI/" .. COMMIT .. "/MuvaUI.lua"
print("[Audit2 v" .. AUDIT_VERSION .. "] Loading MuvaUI from commit " .. COMMIT:sub(1,7) .. "...")
